...
Quantify how discounting affects margin.
Surface loss-making products.
...
Full detail, including the ER diagram: `docs/architecture.md`.
Folder structure
```
...
Download from https://www.kaggle.com/datasets/nnthanh101/aws-saas-sales
Save it as `data/raw/aws_saas_sales.csv`
`python src/pipeline.py` — the real file is detected automatically.
...
`dashboards/SaaS_Sales_PowerBI_Dashboard_Guide.pdf` — a 34-page from-scratch
...
Full analysis: `reports/business_report.md`.
Screenshots
...
Credits
Dataset: published on Kaggle by nnthanh101.
Author: Akshay Juluru — GitHub · LinkedIn
References
Amazon AWS SaaS Sales dataset — https://www.kaggle.com/datasets/nnthanh101/aws-saas-sales
Kimball, R. & Ross, M. The Data Warehouse Toolkit — dimensional modelling and degenerate dimensions.
Microsoft Power BI DAX reference — https://learn.microsoft.com/en-us/dax/
Microsoft Power Query M reference — https://learn.microsoft.com/en-us/powerquery-m/
UCI Online Retail (official-source alternative) — https://archive.ics.uci.edu/dataset/352/online+retail
License
MIT — see LICENSE. The dataset carries its own terms; check the source page before
redistributing.
